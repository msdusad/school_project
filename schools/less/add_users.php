...
<div class="col-xs-12 col-sm-12 col-md-9" id="school_add_user">
...
<div class="row">				
	<div class="col-xs-12 col-sm-12 col-md-12">
		<div class="">
			<h2><i class="glyphicon glyphicon-plus-sign"></i> Welcome to Add Users</h2>
		</div>
	</div>
</div>
<br>
...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12">
		<div class="">
			<h3><i class="glyphicon glyphicon-plus-sign"></i> Add Users</h3>
		</div>
	</div>
</div>
...
<div class="row">				
	...
	<div class="col-xs-12 col-sm-12 col-md-4">
		<div class="">
			<select class="btn btn-primary" name="salutation" id="salutation" required>
...
<div class="row">				
	...
	<div class="col-xs-12 col-sm-12 col-md-6">
		<div class=""><input type="email" name="user_email" id="user_email" required>
		</div>
	</div>
</div>
...
<div class="row">				
	...
	<!-- <div class="col-xs-12 col-sm-12 col-md-4">
		<div class="">
		<select class="btn btn-primary" name="cont_code" style="width:40%;">
	...
	<div class="col-xs-12 col-sm-12 col-md-6">
		<div class="">
			<input type="text" name="user_telephone" id="user_telephone" onkeypress="return isNumberKey(event)" required maxlength="15">
		</div>
	</div>
</div>
...
<div class="row">				
	<div class="col-xs-12 col-sm-12 col-md-6">
		<div class="">
			<input class="btn btn-primary" type="submit" name="add_users" value="Add User & Send Invitation">
		</div>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-6">
		<div class="">
			<input class="btn btn-danger" type="submit" onclick="return restform();"  value="Cancel">
		</div>
	</div>
</div>
