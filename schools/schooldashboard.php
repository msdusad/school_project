...
$employers=mysql_query("select count(*) as total_emp from add_employer where userid='$curuser';");

$students=mysql_query("SELECT count(a.userid) as totalstd FROM student_profile a ,student_school b ,login c where b.school_name='$school_name' && a.userid=c.userid && c.account_status='true';");
		...
		<div class="col-xs-12 col-sm-12 col-md-6">
			<div class="empDbLocationBox">
				...
				<div style="display:inline-block; float:right; text-align:right;">
					Employers
					<h1><?php while($totalemp=mysql_fetch_array($employers)){

echo $totalemp['total_emp'];
}
?></h1>
				</div>
			</div>
	...
	<a href="manage_students.php">
		<div class="col-xs-12 col-sm-12 col-md-6">
			<div class="empDbLocationBox">
				...
				<div style="display:inline-block; float:right; text-align:right;">
					Students
				<h1><?php while($totalstd=mysql_fetch_array($students)){
echo $totalstd['totalstd'];
