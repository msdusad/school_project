...
<script>
function searchstudent(first,type,school){
 	...
 	document.getElementById("all_vacancy").style.display="none";
        ...
        xmlhttp.open("GET","../classes/school/srch_mang_std.php?first="+first+"&type="+type+"&school_name="+school,true);
        xmlhttp.send();
        }
	</script>
</head>
...
<div class="row">				
	...
	<div class="col-xs-12 col-sm-12 col-md-4">
		<div class="mq-center">
			...
			<select class="btn btn-primary" name="invitstion_status" onchange="searchstudent(this.value,'invite_status','<?php echo $school_name;?>')">
	...
	<div class="col-xs-12 col-sm-12 col-md-4">
		<div class="mq-center">
			...
			<select class="btn btn-primary" name="reference_status" onchange="searchstudent(this.value,'ref_status','<?php echo $school_name;?>')">
			<option value="all">All</option>
...
<div class="row">				
	<div class="col-xs-12 col-sm-12 col-md-3">
		<div class="mq-center">
		<label>Show</label>
		<select class="btn btn-primary btn-sm" name="num_of_vacancy_show" onchange="searchstudent(this.value,'limitofsch','<?php echo $school_name;?>')">
	...
	<div class="col-xs-12 col-sm-12 col-md-4">
		...
		<input type="search" name="search_vacancy" onkeyup="searchstudent(this.value,'searchstudent','<?php echo $school_name;?>')">
		</div>
	</div>
</div>
</table>
...
$sql = mysql_query("SELECT a.userid FROM student_profile a ,student_school b ,login c where b.school_name='$school_name' && a.userid=c.userid && c.account_status='true'  ");
while($name=mysql_fetch_array($sql))
{
	$uname=$name['userid'];
$all_vacancy=mysql_query("select a.userid,a.first_name, a.last_name,b.reference_by_school,count(c.student_userid) as student_userid from student_profile a,student_school b, job_applied c ,login d where  a.userid=b.userid and b.userid=c.student_userid and c.student_userid='$uname' && d.userid='$uname' && d.account_status='true' ");
