...
$sql = mysql_query("SELECT a.*,b.account_status FROM school_registration a,login b where a.userid=b.userid");
while($name=mysql_fetch_array($sql))
{
	
?>
		<tr><td><?php echo $name['school_first_name']." ".$name['school_last_name'];?></td>
			<td><?php echo $name['school_name'];?></td>
			<td><?php echo $name['school_email'];?></td>
			<td><?php echo $name['school_telephone'];?></td>
...
?>
			...
			<td><a href="../classes/school_delete.php?schluserid=<?php echo $name['userid'];?>" onclick="return confirm('Are You Sure To Want Delete This')"><i class="fa fa-trash"></i></a></td>
		</tr>
		<?php 
}
		?>
