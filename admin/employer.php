...
<div class="col-xs-12 col-sm-12 col-md-9">
 ...
 <tr><td>Company Address </td>
    ...
    <td><textarea type="text" name="company_address" id="company_address" style="width:100%;"  rows="6" cols="20" required></textarea></td></tr>
   ...
   <tr><td> Postal Code</td>
    ...
    <tr><td>Country</td><td><select name="company_country" class="btn btn-primary" style="width:40%;">
...
<tr><td>First Name</td><td><select name="company_sir_title" id="company_sir_title" class="btn btn-primary" required>
    ...
    <input type="text" name="company_f_name" id="company_f_name"  required></td>
</tr>
 ...
 <tr><td> Telephone </td>
    <td>
    <select name="country_code" class="btn btn-primary" style="width:40%;">
    ...
    <br><br><input type="text" name="company_telephone" id="company_telephone" onkeypress="return isNumberKey(event)" maxlength="15" required ></td></tr>
    
    <tr><td><input class="btn btn-primary" type="submit" name="add_employer" value="Add Employer & Send Invitation" ></td><td><input type="submit" value="Cancel" onclick="return restform();" class="btn btn-danger"></td></tr>
				</table>
