...
<hr style="border-top:1px dashed lightgray;"/>
			...
			<div class="row">				
				...
				<div class="col-xs-12 col-sm-12 col-md-6">
					<div class="">
						<input type="date" class="datepicker" size="8" value="" name="from_date1" placeholder="From Date 1" required>
					</div>
				</div>
			</div>
...
<hr style="border-top:1px dashed lightgray;"/>
			...
			<div class="row">				
				...
				<div class="col-xs-12 col-sm-12 col-md-6">
					<div class="">
						<input type="date" class="datepicker" size="8" value="" name="to_date1" placeholder="To Date 1" required>
					</div>
				</div>
			</div>
