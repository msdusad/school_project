	  ...
	  <div class="row" style="margin-top:30px;">
        <div class="panel panel-default empSearchfilterTwo">
            <div class="panel-body">
				...
				<input type="text" class="form-control" onkeyup="searchvacancy(this.value)" id="inputError" style="border-radius:4px; border:1px solid lightgray;"/>
							</form>
						</div>
					</div>
				</div>
    ...
    <tbody>
      <tr>
        ...
        <td><?php echo  $row['number_places'];?></td>
         <td> <a href="edit_vacancy.php?id=<?php echo$row['id'];?>">Edit</a> </td>
	<?php } 
	?>
      </tr>
    </tbody>
