...
<div class="row">
  ...
  <h5>Welcome back John</h5>
    ...
    <div class="list-group list-group-margingAdj">
        <a href="#fakeLink" class="list-group-item"><img src="img/girlPro-xs.png" alt="title" class="girlProIcon"/><span class="badge">83%</span> Profile</a>
        <a href="#fakeLink" class="list-group-item active"><img src="img/docsInfo-xs.png" alt="title" class="docInfo"/><span class="badge">2/7</span>Application</a>
