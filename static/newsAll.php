...
<!--                 	<ul>
  ...
  <div class="clearfix visible-md"></div>    
    ...
    <img src="img/happyClimb.png" alt="title" class="news_bnr_pix_height_adj">
    </div>
  <div class="col-xs-12 col-sm-12 col-md-5">
  	<div class="news-bnr_txt_group">
      <p class="news-all-bnr-h-a">Work Tester</p>
      <p class="news-all-bnr-h-b">News..</p>
	</div>
...
<div class="row bgcolor-abt-01">
	...
	<div class="">
    <a href="news.php"><h2 class="newsTitle">News Post title</h2></a>
...
... </p>
    ...
    <div class="bgcolor-news-post" style="padding: 5px 20px;">
        <a href="news.php"><h2 class="newsTitle">News Post title</h2></a>
  <div class="keywordCont">
                <ul>
                    <li><a href="#">4 June</a></li>
