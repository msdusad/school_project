...
$sql=mysql_query("insert into contactus (name,mobile_number,email,message) values ('$name','$telephone','$email','$message');");
  ...
  $redirect=$_SERVER['HTTP_REFERER'];
   $message = "We Contact with You Shortly";
echo "<script type='text/javascript'>alert('$message');window.location.href='$redirect';</script>";
  ...
  $to="mike.allen@vibemarketing.co.uk";  
  $subject = 'Worktaster Contact Enquiry';
	$message="
<html>
<head>
  <title>Title</title>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='color:#555555;font-size:16px;line-height:24px;text-align:left;font-family: Helvetica Neue;'>
                              <p> Name : ".$name." <br/> Email : ".$email." <br/> Telephone : ".$telephone." <br/> Message : ".$message." </p>
                            </div>
                          </div>
                        </td>
                      </tr>
