...
var schhol_level=document.getElementById('school_level').value;
alert(schhol_level);
  if (schhol_level == '3') {
document.getElementById('a_levels').style.display = 'none';
document.getElementById('gcses_id').style.display = 'none';
...
<div class="col-xs-12 col-sm-12 col-md-9" id="school_edit-form">
...
<div class="row">
	...
	<div class="row">
	<div class="col-md-11">
		<h4><i class='fa fa-caret-right'></i> Education</h4>
	</div>
	<div class="col-md-1">
	...
	<h4><i class='fa fa-caret-right'></i> Current</h4>
	<br>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-6">	
	</div>
	...
	<div class="col-md-6 emright"><?php echo $other_school_start_month."/".$other_school_start_year." - ".$other_school_end_month."/".$other_school_end_year?></div><br><br>
...
<hr style="border-top:1px dashed lightgray;"/>
				<div class="row">				
					<div class="col-md-12"> <h2><i class='fa fa-caret-right'></i> Education Information</h2> </div>
				</div>			
<hr style="border-top:1px dashed lightgray;"/>
...
<hr style="border-top:1px dashed lightgray;"/>
				<div class="row cv_edu_input_adj">				
					...
					<div class="col-xs-12 col-sm-12 col-md-6"><textarea type="text" row="5" COLS="15" name="school_address"><?php echo $school_address;?></textarea></div>
				</div>
<hr style="border-top:1px dashed lightgray;"/>
				<div class="row cv_edu_input_adj">				
					<div class="col-xs-12 col-sm-12 col-md-6">
...
<hr style="border-top:1px dashed lightgray;"/>
				<div class="row cv_edu_input_adj">				
					<div class="col-xs-12 col-sm-12 col-md-6">
					<label>When did you start School/College here?</label>
					</div>
				...
				<div class="row cv_edu_input_adj">				
					<div class="col-xs-12 col-sm-12 col-md-6">
					<label>What are you currently studying towards (select one)?</label>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-6">
<select id="school_level" class="btn btn-primary" name="currently_studying" id="currently_studying" onchange="inscheck(this.value)">
<?php
if($currently_studying!=''){
	if($currently_studying=='1'){
echo '<option value="1">GCSEs</option>';
	}
		if($currently_studying=='2'){
echo '<option value="2">A-Level</option>';
	}
		if($currently_studying=='3'){
echo '<option value="3">BTECH</option>';
	}
...
?>
				...
				<div class="row">				
					<div class="col-xs-12 col-sm-12 col-md-12">
						<label style="margin: 15px 0px;"><i class='fa fa-caret-right'></i> GCSE summary: you can give here a short explanation of why you have selected the GCSEs below (optional)</label></div>
					<div class="col-xs-12 col-sm-12 col-md-12">
...
<hr style="border-top:1px dashed lightgray;"/>
				...
				<div class="row cv_edu_input_adj">				
					<div class="col-xs-12 col-sm-12 col-md-6"><label>Subjects(s)</label></div>
					<div class="col-xs-12 col-sm-12 col-md-6"><label>Expected Grade(s)</label></div>
				</div>
<hr style="border-top:1px dashed lightgray;"/>
                ...
                <div class="a-levels" id="a_levels" style="display:none;">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="btn btn-primary" name="select_school_same" id="select_school_same" onchange="school_update(this.value);" required>
...
<hr style="border-top:1px solid lightgray;" >
	...
	<div class="row">
			...
			<div class="col-md-2">
					<input class="btn btn-primary cv_edu_saveBtn" type="submit" name="cv_education_detail_sub" value="Save">
			</div>
