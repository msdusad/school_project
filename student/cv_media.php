...
<br>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="cv_media.php">Media</a></li>
    ...
    <div class="row">
        ...
        <div class="row" style="margin-top:30px;">
			<div class="col-md-11">
				<h3 class="cv_achivement_h"><i class='fa fa-caret-right'></i> Media</h3>
			</div>
			<div class="col-md-1">
       ...
       <div id="contactdetail" style="font-size:20px;">
		   <br>
			<div class="stdWelcomeBlock">
				<video  controls >
					<source src="student_docs/video/<?php echo $cv_video;?>" type="video/mp4">
					<source src="student_docs/video/<?php echo $cv_video;?>" type="video/ogg">
					<source src="student_docs/video/<?php echo $cv_video;?>" type="video/webm">
				</video>
			<!-- src="student_docs/video/" -->
			</div>
       </div>
		...
		<hr style="border-top:1px dashed lightgray;">
			...
			<div class="row">			
					<div class="col-xs-12 col-sm-12 col-md-12"><h1 class="cv_achivement_hMedia"><i class="fa fa-caret-right"></i> Media</h1></div>
			</div>
			
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-6"><h2 class="cv_media_h"><i class="fa fa-hand-o-right"></i> Select A File</h2></div>
				<div class="col-xs-12 col-sm-12 col-md-6"><input type="file" name="video" id="video" style="padding:5px;" required></div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<input type="submit" name="video_upload" value="Upload" class="btn btn-primary cv_media_uploadBtn">
				</div>
			</div>
