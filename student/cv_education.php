...
var valueofsch=document.getElementById('currently_studying').value;
 if (valueofsch=='') {
...
<hr style="border-top:1px dashed lightgray;"/>
				...
				<div class="row cv_edu_input_adj">				
					...
					<div class="col-xs-12 col-sm-12 col-md-6">
					<select class="btn btn-primary" name="currently_studying" id="currently_studying" onchange="inscheck(this.value);" required="">
<?php
...
<?php if($select_school_name!=''){
	
	if($select_school_name=='0'){
